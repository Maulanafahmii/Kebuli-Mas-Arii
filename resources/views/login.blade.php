...
<head>
    ...
    <style>
        ...
        /* CTA Button Styles (Kembali ke Desain Awal) */
        .cta-btn {
        ...
        .dropdown-item:hover .menu-preview {
            display: block;
        }
...
<body class="index-page">
    <header id="header" class="header fixed-top">
        ...
        <div class="branding d-flex align-items-center">
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <a class="cta-btn d-none d-xl-block" href="{{ route('login') }}">Log in</a>
            </div>
        </div>
    </header>
    ...
    <main class="main">
                ...
                <div class="row isotope-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    @foreach ($menus as $menu)
                        <div
                            ...
                            @else
                                <img src="{{ asset('assets/img/default-menu.jpg') }}" class="menu-img"
                                    alt="{{ $menu->nama }}" data-bs-toggle="modal"
                                    data-bs-target="#imageModal-{{ $loop->index }}" style="cursor: pointer;">
                            @endif
        ...
        <section id="testimonials" class="testimonials section">
            ...
            <div class="modal fade testimony-modal" id="testimonyModal" tabindex="-1"
                aria-labelledby="testimonyModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="testimony-container">
                                ...
                                <form action="/testimoni/store" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="testimony-name" class="form-label">Nama</label>
                                        <input type="text" class="form-control" id="testimony-name"
                                            name="nama" placeholder="Silakan masukkan nama lengkap Anda" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="testimony-job" class="form-label">Pekerjaan</label>
                                        <input type="text" class="form-control" id="testimony-job"
                                            name="pekerjaan"
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="testimony-text" class="form-label">Ulasan</label>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="testimony-photo" class="form-label">Foto (opsional)</label>
                                        <input type="file" class="form-control-file" id="testimony-photo"
    ...
    <div class="modal fade cart-modal" id="orderModal" tabindex="-1" aria-labelledby="orderModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="orderForm" action="javascript:void(0);">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="order-address" name="alamat" placeholder="Silakan masukkan alamat lengkap Anda"
                                required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="delivery-method" class="form-label">Metode Pengiriman</label>
                            <select class="form-select" id="delivery-method" name="pengiriman" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-outline w-100" type="button" id="menuDropdown"
                                        ...
                                        <li>
                                            <a class="dropdown-item add-to-cart" href="#"
                                                ...
                                                <div class="menu-preview">
                                                    <img src="{{ $menu->foto ? asset('assets/img/menu/' . $menu->foto . '?v=' . time()) : asset('assets/img/default-menu.jpg') }}"
                                                        alt="{{ $menu->nama }}"
                        ...
                        <div class="cart-container">
                            ...
                            <div class="cart-actions">
                                <button type="button" class="btn-primary" id="preview-order">Pratinjau
                                    Pesanan</button>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal fade" id="previewOrderModal" tabindex="-1" aria-labelledby="previewOrderModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="previewOrderModalLabel">Pratinjau Pesanan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="preview-content"></div>
                    <div class="cart-actions">
                        <button type="button" class="btn-primary" id="confirm-order">Konfirmasi & Kirim</button>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.add-to-cart').forEach(button => {
        button.addEventListener('click', function (e) {
            ...
            updateCartDisplay();
            // Removed SweetAlert notification for adding item
        });
    });
                ...
                if (cart[index].quantity > 1) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            localStorage.setItem('cart', JSON.stringify(cart));
                            updateCartDisplay();
                            // Removed SweetAlert success notification after item removal
                        }
                    });
                }
            });
    ...
    document.getElementById('preview-order').addEventListener('click', function () {
        ...
        // Create structured preview content
        let previewContent = `
            <div class="cart-container">
                <h2 class="cart-title">Pratinjau Pesanan</h2>
                <p><strong>Nama:</strong> ${name}</p>
                <p><strong>Alamat:</strong> ${address}</p>
                <p><strong>Metode Pengiriman:</strong> ${deliveryMethod === 'antar' ? 'Diantar' : 'Ambil Sendiri'}</p>
                <div class="cart-header">
                    <div>Item</div>
                    <div>Harga</div>
                    <div>Jumlah</div>
    ...
    document.getElementById('confirm-order').addEventListener('click', function () {
        ...
        const deliveryMethod = document.getElementById('delivery-method').value;
        let total = 0;
        let orderDetails = `Pesanan #${Date.now()} dari: ${name}\nAlamat: ${address}\nMetode Pengiriman: ${deliveryMethod === 'antar' ? 'Diantar' : 'Ambil Sendiri'}\n\nDetail Pesanan:\n`;
        cart.forEach(item => {
            const itemTotal = item.price * item.quantity;
            total += itemTotal;
        ...
        formData.append('pengiriman', deliveryMethod);
        ...
        fetch('/order/store', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    $('#previewOrderModal').modal('hide');
                    Swal.fire({
                        icon: 'success',
                        title: 'Pesanan Berhasil!',
                        text: 'Pesanan Anda telah disimpan dan dikirim melalui WhatsApp.',
                        confirmButtonText: 'OK',
    ...
    // Handle scroll-top error (optional if not needed)
    if (!document.querySelector('.scroll-top')) {
        console.warn('Element .scroll-top not found, skipping scroll functionality.');
    }
});
</script>
</body>
